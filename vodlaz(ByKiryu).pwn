...
SendClientMessage(playerid,0xFF4500FF,"Вы телепортировались на место работы водолазов.");
return 1;
}
//--------------------------------------------------------------------------
...
SetPlayerInterior(playerid,0);
SetPlayerVirtualWorld(playerid,0);
SendClientMessage(playerid,0xFF4500FF,"Вы телепортировались на корабль.");
return 1;
}
